...
import TestimonialImg01 from "@/public/images/FB_IMG_1726525747093.jpg";
...
export default function Recommendations() {
  const items = [
    {
      name: "Travis Michael",
      role: "Internal Technician, Fidelity",
      image: TestimonialImg01,
      link: "#0",
      content:
        "Dakota is a highly skilled web and software developer with a strong ability to create user-friendly, responsive websites and efficient, scalable applications. Their technical expertise, problem-solving skills, and attention to detail ensure top-quality results on every project.",
    },
    {
      name: "Marta Lower",
      role: "CTO, Vimeo",
